    ...
    <div class="control_frm" style="margin-top:25px;">
        <div class="bc">
            <ul id="breadcrumbs" class="breadcrumbs">
                ...
                <li class="current"><a href="#" onclick="return false;">Tạo mới</a></li>
            </ul>
            <div class="clear"></div>
        </div>
        <form name="supplier" id="validate" class="form" action="?c=admin&a=sendtaomoimenu" method="post" >         
            <div class="widget">
                ...
                <div class="tabs_content_container">
                    ...
                    <div id="tabtt" class="tab_content" style="display: block;">
                        <div class="formRow">
                            <label>菜单名称</label>
                            <div class="formRight">
                                <input type="text" placeholder="菜单名称" name="namett" id="username" class="tipS" original-title="">
                            </div>
                            <div class="clear"></div>
                        </div> 
                    </div>
